...
_C.MODEL.NUM_CLASSES_STEPS = 0
_C.MODEL.NUM_CLASSES_TASKS = 0
...
_C.MODEL.UNCERTAINTY_WEIGHT = 1.

_C.MODEL.BCE_WEIGHT = 0.5

# mse loss clamp/clip value
_C.MODEL.MSE_LOSS_CLIP_VAL = 16.0

# focal loss parameters
_C.MODEL.F_LOSS_ALPHA = 1.
_C.MODEL.F_LOSS_BETA = 0.3
_C.MODEL.F_LOSS_GAMMA = 2. 

_C.MODEL.ERROR_DETECTION = None
...
_C.DATA.FEATURES = "features"

_C.DATA.FEATURES_ALREADY_DOWNSAMPLED = False

_C.DATA.OVERRIDE_FEATURE_FPS = None

_C.DATA.LEAVE_ONE_OUT_TEST_SPLIT = None

_C.DATA.NUM_CROSS_VAL_SPLITS = None

_C.DATA.CROSS_VAL_TEST_SPLIT = None

_C.DATA.CROSS_VAL_VALIDATION_SIZE = None

_C.DATA.NORMALIZE = False

_C.DATA.NORMALIZE_PARTS = False

_C.DATA.NORMALIZE_WHOLE = False
...
_C.DATA.PATH_TO_MAPPING_FILE = ''

_C.DATA.PATH_TO_MASTER_CSV = ''

_C.DATA.PATH_TO_MASTER_JSON = ''

_C.DATA.DATASPLIT_CSV = ''
...
# whether or not to normalize input features
_C.DATA.NORMALIZE_FEATS = False

# feature dir to override the one in the master csv
_C.DATA.OVERRIDE_FEATURE_DIR = None
...
_C.SOLVER.GRAD_ACCUMULATION_STEPS = 1
