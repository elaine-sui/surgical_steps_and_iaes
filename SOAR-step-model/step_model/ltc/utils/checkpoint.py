...
def save_checkpoint(path_to_expr: str,
    ...
    if 'VideoF1' in eval_metrics:
        # if best_metrics_sum < eval_metrics['metrics_sum']:
        #     best_metrics_sum = eval_metrics['metrics_sum']
        # if best_metrics_sum < eval_metrics['FramewiseF1']:
        #     best_metrics_sum = eval_metrics['FramewiseF1']
        # if best_metrics_sum > eval_metrics['loss_ce']:
        #     best_metrics_sum = eval_metrics['loss_ce']
        if best_metrics_sum < eval_metrics['VideoF1']:
            best_metrics_sum = eval_metrics['VideoF1']
